    ...
    <body>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lucapic</li>
            </ol>
        </nav>

        <section class="d-flex flex-column text-center">

            <h2 class="daily_recette">Les Lucapic</h2>
            ...
            <ul>
                <li>3kg de lait</li>
                <li>1 paquet de Lucapic</li>
            </ul>
            <hr>
            <h3>Réalisation</h3>
            <ol>
                <li>Versez le lait</li>
                <li>Placez le bol sur le lait</li>
                <li>Ajouter les céréales Lucapic</li>
                <li>Videz le bol</li>
