    ...
    <body>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Soupegoire</li>
            </ol>
        </nav>

        <section class="d-flex flex-column text-center">

            <h2 class="daily_recette">La Soupegoire</h2>
            ...
            <h3>Réalisation</h3>
            <ol>
                <li>Pressez votre Greg pour obtenir une soupe froide</li>
                <li>Ajoutez un zeste de citron</li>
                <li>Mélanger votre soupe avec le litre de Badoit</li>
                <li>Placez la cuillère dans la narine droite</li>
