    ...
    <body>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Crêpe Tova</li>
            </ol>
        </nav>

        <section class="d-flex flex-column text-center">

            <h2 class="daily_recette">La Crêpe Tova</h2>
            ...
            <ul>
                ...
                <li>1kg de Sel</li>
                <li>100g de Sucre</li>
                <li>Viande de boeuf</li>
                <li>1 Tova</li>
            </ul>
            <hr>
            <h3>Réalisation</h3>
            <ol>
                <li>Faites de la pâte à crêpes débrouillez vous</li>
                <li>Ajoutez la viande de boeuf</li>
                <li>Ajoutez votre Tova</li>
                <li>Faites cuire 10min à feu vif</li>
